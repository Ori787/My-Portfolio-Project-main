...
class Question {
    constructor(question, a1, a2, a3, a4, a5, rightAnswer) {
...
class QuizUI {
    constructor() {
        ...
        this.answers = [
            this.getElement(".a1 h3.mytext"),
            this.getElement(".a2 h3.mytext"),
            this.getElement(".a3 h3.mytext"),
            this.getElement(".a4 h3.mytext")
        ];
        this.counter = this.getElement("#counterplace");
        this.nextBtn = this.getElement("#nextquestion");
        this.playground = this.getElement("#playground");
        this.playAgainBtn = this.getElement("#playagainbtn");
    }
    getElement(selector) {
    ...
    disableAnswerButtons() {
        const buttons = Array.from(this.playground.querySelectorAll(".mybtn"));
        buttons.forEach(b => {
            b.disabled = true;
    ...
    showCorrectAnswer(selectedButton, isCorrect) {
        // Add visual feedback
        if (isCorrect) {
...
class QuizController {
    ...
    setupAnswerListeners() {
        const buttons = Array.from(this.ui.playground.querySelectorAll(".mybtn"));
        buttons.forEach((btn, index) => {
            btn.addEventListener("click", () => {
                const myText = btn.parentElement?.querySelector(".mytext");
                if (!myText)
                    return;
